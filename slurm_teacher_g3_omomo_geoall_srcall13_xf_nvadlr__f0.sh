...
#SBATCH --job-name="tch-g3_omomo_geoall_srcall13_xf_nvadlr__f0"
#SBATCH --output=teacher-g3_omomo_geoall_srcall13_xf_nvadlr__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# ALL-SOURCE g3 teacher, TRANSFORMER + NVADLR twin: 13 sources x 43 bodies, RAGGED.
# Env = the srcall13 arm verbatim; train cfg = 6-token transformer, normalize_value
# + adaptive LR (exact-KL 0.06). Own experiment name -> own checkpoint dir.
# Hand-written from slurm_teacher_g3_omomo_geoall_srcall13__f0.sh (the MLP twin).
...
# Eval when done:  HELDOUT="sub10 sub13 sub16" sh scripts/eval_one.sh g3_omomo_geoall_srcall13_xf_nvadlr__f0
#
...
#       --bodies-from isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_omomo_geoall_srcall13_xf_nvadlr__f0.yaml
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_omomo_geoall_srcall13_xf_nvadlr__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g3_omomo_geoall_srcall13_xf_nvadlr__f0.yaml
...
echo "[teacher] G3 RECIPE g3_omomo_geoall_srcall13_xf_nvadlr__f0 (OMOMO data, 13 sources, RAGGED motion, 6-TOKEN TRANSFORMER, normval+adaptive LR): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g3_omomo_geoall_srcall13_xf_nvadlr__f0/nn/"
