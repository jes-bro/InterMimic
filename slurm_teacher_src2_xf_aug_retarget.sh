...
#SBATCH --job-name="tch-src2_xf_aug_retarget"
#SBATCH --output=teacher-src2_xf_aug_retarget-%j.out
...
#
# Runs from repo root. Saves to checkpoints/smplx_teacher_src2_xf_aug/nn/.
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_src2_xf_aug_retarget.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src2_xf_aug_retarget.yaml
...
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_src2_xf_aug/nn/"
