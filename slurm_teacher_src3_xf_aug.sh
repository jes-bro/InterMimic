...
#SBATCH --job-name="tch-src3_xf_aug"
#SBATCH --output=teacher-src3_xf_aug-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# SOURCE-TEACHER validation run: source=sub3 driving ALL 14 train bodies,
...
#
# Runs from repo root. Saves to checkpoints/smplx_teacher_src3_xf_aug/nn/.
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_src3_xf_aug.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src3_xf_aug.yaml
...
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_src3_xf_aug/nn/"
