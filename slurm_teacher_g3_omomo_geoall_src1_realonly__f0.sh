...
echo "[teacher] G3 RECIPE g3_omomo_geoall_src1_realonly__f0 (OMOMO data): 13 REAL bodies (ablation, no synthetic), no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
