...
#SBATCH --job-name="tch-g3_cpr6_geoall__f0"
#SBATCH --output=teacher-g3_cpr6_geoall__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# THE OTHER HALF of cpr13: 6 CPR people NOT in cpr7 (sub510 sub513 sub565 sub566 sub577 sub580), 6 clips, recipe and data verbatim from the
# cpr13 launcher; only dataSub differs. Pairs with cpr7 as a halves split.
# Eval when done:  HELDOUT="sub10 sub13 sub16" sh scripts/eval_one.sh g3_cpr6_geoall__f0
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_cpr6_geoall__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g3_cpr6_geoall__f0.yaml
...
for s in sub510 sub513 sub565 sub566 sub577 sub580; do
...
echo "[teacher] G3 RECIPE g3_cpr6_geoall__f0 (EgoExo4D CPR, the 6 people not in cpr7, 6 clips): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g3_cpr6_geoall__f0/nn/"
