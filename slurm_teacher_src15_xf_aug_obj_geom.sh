...
#SBATCH --job-name="tch-src15_xf_aug_obj_geom"
#SBATCH --output=teacher-src15_xf_aug_obj_geom-%j.out
...
#
# Runs from repo root. Saves to checkpoints/smplx_teacher_src15_xf_aug_obj_geom/nn/.
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_src15_xf_aug_obj_geom.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src15_xf_aug_obj_geom.yaml
...
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_src15_xf_aug_obj_geom/nn/"
