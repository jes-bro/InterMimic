...
#SBATCH --job-name="tch-src11_xf_aug_obj"
#SBATCH --output=teacher-src11_xf_aug_obj-%j.out
...
#
# Runs from repo root. Saves to checkpoints/smplx_teacher_src11_xf_aug_obj/nn/.
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_src11_xf_aug_obj.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src11_xf_aug_obj.yaml
...
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_src11_xf_aug_obj/nn/"
