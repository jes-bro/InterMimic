...
#SBATCH --job-name="stu-g3_act_mlp_ret_stock__f0"
#SBATCH --output=student-g3_act_mlp_ret_stock__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, ACTIVITIES, MLP / RET / STOCK: bball7 + soccer15 + cpr13 g3 teachers
# (3 checkpoints, 35 sources) distilled into one MLP student
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 act_mlp   -- fits a2-highgpu-1g
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_act_mlp_ret_stock__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_act_mlp_ret_stock__f0.yaml
...
echo "[student] ACTIVITY MLP/RET/STOCK student: bball7+soccer15+cpr13 -> MLP 1024/1024/512, 6 student horizons (9594), constant LR, per-object physics, RAGGED, num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_act_mlp_ret_stock__f0/nn/"
