...
#SBATCH --job-name="tch-g3_bball7_geoall_noret__f0"
#SBATCH --output=teacher-g3_bball7_geoall_noret__f0-%j.out
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_bball7_geoall_noret__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g3_bball7_geoall_noret__f0.yaml
...
echo "[teacher] G3 RECIPE g3_bball7_geoall_noret__f0 (EgoExo4D bball, 7 people, 52 clips, per-clip balls): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g3_bball7_geoall_noret__f0/nn/"
echo "[teacher] ABLATION noret of g3_bball7_geoall__f0: retargetedMotionDir removed (every body tracks the SOURCE reference, no cross-body retargeting)"
