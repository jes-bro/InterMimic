...
#SBATCH --job-name="stu-g3_omomo_xf_ret_nvadlr_bodyonly__f0"
#SBATCH --output=student-g3_omomo_xf_ret_nvadlr_bodyonly__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, OMOMO, XF / RET / NVADLR + BODYONLY (ATTRIBUTION CELL for Arm A): the 13 per-source g3 OMOMO teachers distilled
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 omomo_xf_bodyonly
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_omomo_xf_ret_nvadlr_bodyonly__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_omomo_xf_ret_nvadlr_bodyonly__f0.yaml
...
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_omomo_xf_ret_nvadlr_bodyonly__f0/nn/"
