...
#SBATCH --job-name="tch-g3_cpr13_geoall__f0"
#SBATCH --output=teacher-g3_cpr13_geoall__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# g3 RECIPE ON THE EGOEXO4D CPR RECONSTRUCTION: 23 clips from 13 people
# (sub509 510 512 513 517 564 565 566 567 569 577 579 580) x f0's 43 bodies,
...
# Eval when done:  HELDOUT="sub10 sub13 sub16" sh scripts/eval_one.sh g3_cpr13_geoall__f0
#
# --mem=64G: 989 (body, clip) motions padded to the 691-frame longest clip is
# ~6 GB of motion; bball7 runs at 64G with 3.4 GB.
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_cpr13_geoall__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g3_cpr13_geoall__f0.yaml
...
for s in sub509 sub510 sub512 sub513 sub517 sub564 sub565 sub566 sub567 sub569 sub577 sub579 sub580; do
...
echo "[teacher] G3 RECIPE g3_cpr13_geoall__f0 (EgoExo4D CPR, 13 people, 23 clips, static 3.7 kg manikin): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g3_cpr13_geoall__f0/nn/"
