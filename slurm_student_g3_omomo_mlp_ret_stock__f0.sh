...
#SBATCH --job-name="stu-g3_omomo_mlp_ret_stock__f0"
#SBATCH --output=student-g3_omomo_mlp_ret_stock__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, OMOMO, MLP / RET / STOCK: the 13 per-source g3 OMOMO teachers distilled
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 omomo_mlp
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_omomo_mlp_ret_stock__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_omomo_mlp_ret_stock__f0.yaml
...
echo "[student] OMOMO MLP/RET/STOCK student: 13 g3 teachers -> MLP 1024/1024/512, 6 student horizons (9594), constant LR, RAGGED, num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_omomo_mlp_ret_stock__f0/nn/"
