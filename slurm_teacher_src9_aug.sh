...
#SBATCH --job-name="tch-src9_aug"
#SBATCH --output=teacher-src9_aug-%j.out
...
#
# Runs from repo root. Saves to checkpoints/smplx_teacher_src9_aug/nn/.
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_src9_aug.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src9_aug.yaml
...
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_src9_aug/nn/"
