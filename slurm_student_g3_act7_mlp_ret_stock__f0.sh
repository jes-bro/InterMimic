...
#SBATCH --job-name="stu-g3_act7_mlp_ret_stock__f0"
#SBATCH --output=student-g3_act7_mlp_ret_stock__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, ACTIVITIES-7, MLP / RET / STOCK: bball7 + soccer7 + cpr7 g3 teachers
# (3 checkpoints, 21 sources) distilled into one MLP student
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 act7_mlp   -- fits a2-highgpu-1g
#
...
#   1. python3 scripts/merge_activity_data.py --arms bball7 soccer7 cpr7 \
#          --out-motion InterAct/behave_cari4d_act7 \
#          --out-retarget InterAct/behave_cari4d_act7_f0_bodymajor \
#          --props-out isaacgym/src/intermimic/data/cfg/object_props_g3_act7.yaml \
#          --bodies-from isaacgym/src/intermimic/data/cfg/omomo_student_g3_act7_mlp_ret_stock__f0.yaml \
...
#   2. python3 scripts/collect_g3_teachers.py --activities bball7 soccer7 cpr7 \
#          --out checkpoints/teachers/g3_act7
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_act7_mlp_ret_stock__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_act7_mlp_ret_stock__f0.yaml
...
echo "[student] ACTIVITY MLP/RET/STOCK student: bball7+soccer7+cpr7 -> MLP 1024/1024/512, 6 student horizons (9594), constant LR, per-object physics, RAGGED, num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_act7_mlp_ret_stock__f0/nn/"
