...
# (test bodies: sub10 sub13 sub16). Generated by scripts/generate_gen2_arms.py.
...
echo "[teacher] GEN2 g2_mlp_plain_nvadlr__f0: arch=mlp refs=plain recipe=nvadlr fold=f0 num_envs=$NUM_ENVS"
