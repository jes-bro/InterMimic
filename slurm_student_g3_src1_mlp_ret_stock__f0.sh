...
#SBATCH --job-name="stu-g3_src1_mlp_ret_stock__f0"
#SBATCH --output=student-g3_src1_mlp_ret_stock__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, SRC1, MLP / RET / STOCK: the single sub1 g3 teacher (the ablation base source) -- a one-source student, 43 target bodies
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 src1_mlp   -- shape: a2-highgpu-4g (a2-highgpu-2g if the srcall13 RSS shows the ragged factor near 1.0)
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_src1_mlp_ret_stock__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_src1_mlp_ret_stock__f0.yaml
...
echo "[student] SRC1 MLP / RET / STOCK student: the single sub1 g3 teacher (the ablation base source) -- a one-source student, 43 target bodies -> MLP 1024/1024/512, 6 student horizons (9594), constant LR, num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_src1_mlp_ret_stock__f0/nn/"
