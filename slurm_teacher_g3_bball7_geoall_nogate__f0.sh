...
#SBATCH --job-name="tch-g3_bball7_geoall_nogate__f0"
#SBATCH --output=teacher-g3_bball7_geoall_nogate__f0-%j.out
...
# Eval when done:  HELDOUT="sub10 sub13 sub16" sh scripts/eval_one.sh g3_bball7_geoall_nogate__f0
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_bball7_geoall_nogate__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g3_bball7_geoall_nogate__f0.yaml
