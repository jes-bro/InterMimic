...
#SBATCH --job-name="tch-g2_xf_plain_stock__f1"
#SBATCH --output=teacher-g2_xf_plain_stock__f1-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# GEN-2 grid cell: arch=xf refs=plain recipe=stock fold=f1
...
# Eval when done:  HELDOUT="sub5 sub7 sub12" sh scripts/eval_one.sh g2_xf_plain_stock__f1
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g2_xf_plain_stock__f1.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g2_xf_plain_stock__f1.yaml
...
echo "[teacher] GEN2 g2_xf_plain_stock__f1: arch=xf refs=plain recipe=stock fold=f1 buf=12.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g2_xf_plain_stock__f1/nn/"
