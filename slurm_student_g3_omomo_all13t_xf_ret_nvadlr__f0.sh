...
#SBATCH --job-name="stu-g3_omomo_all13t_xf_ret_nvadlr__f0"
#SBATCH --output=student-g3_omomo_all13t_xf_ret_nvadlr__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, OMOMO, XF / RET / NVADLR: the single srcall13 teacher (one checkpoint, all 13 sources) -- distillation as pure architecture/optimizer transfer distilled
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 omomo_all13t_xf
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_omomo_all13t_xf_ret_nvadlr__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_omomo_all13t_xf_ret_nvadlr__f0.yaml
...
echo "[student] OMOMO XF/RET/NVADLR student: 1 all-source teacher -> 6-token transformer (9594), normval + adaptive LR (KL 0.06), RAGGED, num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_omomo_all13t_xf_ret_nvadlr__f0/nn/"
