...
#SBATCH --job-name="tch-g2_mlp_ret_stock_buf20__f0"
#SBATCH --output=teacher-g2_mlp_ret_stock_buf20__f0-%j.out
...
# Eval when done:  HELDOUT="sub10 sub13 sub16" sh scripts/eval_one.sh g2_mlp_ret_stock_buf20__f0
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g2_mlp_ret_stock_buf20__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g2_mlp_ret_stock_buf20__f0.yaml
...
echo "[teacher] GEN2 g2_mlp_ret_stock_buf20__f0: arch=mlp refs=ret recipe=stock fold=f0 buf=20.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g2_mlp_ret_stock_buf20__f0/nn/"
