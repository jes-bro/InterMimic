...
#SBATCH --job-name="stu-g3_bball7_mlp_ret_stock__f0"
#SBATCH --output=student-g3_bball7_mlp_ret_stock__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, BBALL7, MLP / RET / STOCK: the bball7 g3 teacher alone (7 EgoExo4D people, 48 clips, per-clip balls) -- the basketball-only student
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 bball7_mlp   -- shape: a2-highgpu-1g
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_bball7_mlp_ret_stock__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_bball7_mlp_ret_stock__f0.yaml
...
echo "[student] BBALL7 MLP / RET / STOCK student: the bball7 g3 teacher alone (7 EgoExo4D people, 48 clips, per-clip balls) -- the basketball-only student -> MLP 1024/1024/512, 6 student horizons (9594), constant LR, num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_bball7_mlp_ret_stock__f0/nn/"
