...
#SBATCH --job-name="stu-g3_act_xf_ret_nvadlr_matchctr__f0"
#SBATCH --output=student-g3_act_xf_ret_nvadlr_matchctr__f0-%j.out
...
# (cohortClips 4; a no-op on the activity data, one clip per object). NO body wire.
...
# On GCP / any machine without Slurm: NUM_ENVS=1024 sh scripts/gcp_run_in_tmux.sh $0 act_xf_matchctr
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_act_xf_ret_nvadlr_matchctr__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_act_xf_ret_nvadlr_matchctr__f0.yaml
...
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_act_xf_ret_nvadlr_matchctr__f0/nn/"
