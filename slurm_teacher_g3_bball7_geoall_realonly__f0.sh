...
echo "[teacher] G3 RECIPE g3_bball7_geoall_realonly__f0 (EgoExo4D bball, 7 people, 52 clips, per-clip balls): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
