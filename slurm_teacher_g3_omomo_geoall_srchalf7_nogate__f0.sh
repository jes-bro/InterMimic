...
echo "[teacher] G3 RECIPE g3_omomo_geoall_srchalf7_nogate__f0 (OMOMO data, half B = 7 sources, RAGGED motion): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
