...
#SBATCH --job-name="tch-src12_xf_aug_obj_cond"
#SBATCH --output=teacher-src12_xf_aug_obj_cond-%j.out
...
#
# Runs from repo root. Saves to checkpoints/smplx_teacher_src12_xf_aug_obj_cond/nn/.
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_src12_xf_aug_obj_cond.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src12_xf_aug_obj_cond.yaml
...
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_src12_xf_aug_obj_cond/nn/"
