...
#SBATCH --job-name="tch-kfold1_src2_mlp"
#SBATCH --output=teacher-kfold1_src2_mlp-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# k-fold CV fold (generated by scripts/generate_kfold_cfgs.py).
# TEST bodies (held out of training): sub5 sub7 sub12
...
# Eval when done:  HELDOUT="sub5 sub7 sub12" sh scripts/eval_one.sh kfold1_src2_mlp
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_kfold1_src2_mlp.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_kfold1_src2_mlp.yaml
...
echo "[teacher] KFOLD kfold1_src2_mlp: test bodies sub5 sub7 sub12 held out; stock MLP recipe, lowbuf 12.0"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_kfold1_src2_mlp/nn/"
