...
#SBATCH --job-name="stu-g3_omomo7_xf_ret_nvadlr__f0"
#SBATCH --output=student-g3_omomo7_xf_ret_nvadlr__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# STUDENT, OMOMO7, XF / RET / NVADLR: the 7 per-source g3 OMOMO teachers of the srchalf7 split (sub2 6 7 8 9 11 14) -- the student twin of the srchalf7 ablation base
...
# On GCP (no Slurm): sh scripts/gcp_run_in_tmux.sh $0 omomo7_xf   -- shape: a2-highgpu-4g
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_student_g3_omomo7_xf_ret_nvadlr__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_student_g3_omomo7_xf_ret_nvadlr__f0.yaml
...
echo "[student] OMOMO7 XF / RET / NVADLR student: the 7 per-source g3 OMOMO teachers of the srchalf7 split (sub2 6 7 8 9 11 14) -- the student twin of the srchalf7 ablation base -> 6-token transformer (9594), normval + adaptive LR (KL 0.06), num_envs=$NUM_ENVS"
echo "[student] host=$(hostname) job=${SLURM_JOB_ID:-none} -> checkpoints/smplx_student_g3_omomo7_xf_ret_nvadlr__f0/nn/"
