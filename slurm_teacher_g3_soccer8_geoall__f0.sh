...
#SBATCH --job-name="tch-g3_soccer8_geoall__f0"
#SBATCH --output=teacher-g3_soccer8_geoall__f0-%j.out

#SBATCH --mail-user=jesb@stanford.edu
#SBATCH --mail-type=ALL

# THE OTHER HALF of soccer15: 8 soccer people NOT in soccer7 (sub480 sub488 sub489 sub491 sub494 sub495 sub496 sub497), 14 clips, recipe and data verbatim from the
# soccer15 launcher; only dataSub differs. Pairs with soccer7 as a halves split.
# Eval when done:  HELDOUT="sub10 sub13 sub16" sh scripts/eval_one.sh g3_soccer8_geoall__f0
#
...
CFG_ENV=isaacgym/src/intermimic/data/cfg/omomo_teacher_g3_soccer8_geoall__f0.yaml
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_g3_soccer8_geoall__f0.yaml
...
for s in sub480 sub488 sub489 sub491 sub494 sub495 sub496 sub497; do
...
echo "[teacher] G3 RECIPE g3_soccer8_geoall__f0 (EgoExo4D soccer, the 8 people not in soccer7, 14 clips): 43 bodies, no betas, gate resets=true, rollout 50, buf=12.0 num_envs=$NUM_ENVS"
echo "[teacher] host=$(hostname) job=$SLURM_JOB_ID -> checkpoints/smplx_teacher_g3_soccer8_geoall__f0/nn/"
