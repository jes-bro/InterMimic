...
#SBATCH --job-name="tch-src2_xf_aug"
#SBATCH --output=teacher-src2_xf_aug-%j.out
...
CFG_TRAIN=isaacgym/src/intermimic/data/cfg/train/rlg/omomo_teacher_src2_xf_aug.yaml
