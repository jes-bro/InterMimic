#!/bin/bash
# Render qualitative comparisons for sub6 source motion, on held-out
...
# Force SOURCE_SUB=sub6 in the main script for these runs.
sed -i 's/^SOURCE_SUB=.*/SOURCE_SUB=sub6/' "$SCRIPT"

for BODY in sub1 sub5; do
    for OBJ in woodchair largetable; do
        echo ""
        echo "=================================================================="
        echo "=== Combo: TARGET_BODY=$BODY  OBJECT=$OBJ  (source = sub6) ==="
        echo "=================================================================="
